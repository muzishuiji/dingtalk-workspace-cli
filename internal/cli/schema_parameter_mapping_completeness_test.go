...
func TestDeliveryCatalogLocalInterfacesAreExactAndReviewed(t *testing.T) {
	wantReasons := map[string]string{
		...
		"card.block_list":      "implemented by the embedded DWS A2UI authoring runtime",
		"card.block_show":      "implemented by the embedded DWS A2UI authoring runtime",
		"card.build":           "implemented by the embedded DWS A2UI authoring runtime",
		"card.catalog_get":     "implemented by the embedded DWS A2UI authoring runtime",
		"card.catalog_list":    "implemented by the embedded DWS A2UI authoring runtime",
		"card.catalog_search":  "implemented by the embedded DWS A2UI authoring runtime",
		"card.compose":         "implemented by the embedded DWS A2UI authoring runtime",
		"card.doctor":          "implemented by the embedded DWS A2UI authoring runtime",
		"card.guide_recommend": "implemented by the embedded DWS A2UI authoring runtime",
		"card.guide_rules":     "implemented by the embedded DWS A2UI authoring runtime",
		"card.lint":            "implemented by the embedded DWS A2UI authoring runtime",
		"card.list":            "implemented by the embedded DWS A2UI authoring runtime",
		"card.preview":         "implemented by the embedded DWS A2UI authoring runtime",
		"card.protocol_info":   "implemented by the embedded DWS A2UI authoring runtime",
		"card.protocol_verify": "implemented by the embedded DWS A2UI authoring runtime",
		"card.recipe_list":     "implemented by the embedded DWS A2UI authoring runtime",
		"card.recipe_show":     "implemented by the embedded DWS A2UI authoring runtime",
		"card.show":            "implemented by the embedded DWS A2UI authoring runtime",
		"card.verify":          "implemented by the embedded DWS A2UI authoring runtime",
	}
	loaded := mustDeliverySchemaCatalogMaps(t)
	if !deliverySchemaCatalogAvailable() {
		t.Fatalf("delivery schema Catalog is unavailable: %v", deliverySchemaCatalogError())
